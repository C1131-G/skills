...
| [audit-project-skills](./audit-project-skills/SKILL.md) | Picking the skills a project's `package.json` implies, then auditing every rule and planning the fixes | `detection.md`, `tanstack.md`, `evidence.md`, `report.md` |
