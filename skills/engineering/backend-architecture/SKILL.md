...
description: Feature modules, routes→controller→service→repository. Called by master / backend router.
...
| Request logging | Structured, with a request ID propagated through the request (see `structured-logging`) |
