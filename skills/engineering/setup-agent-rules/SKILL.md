...
`AGENTS.md` contains the complete decision-tree table; any pre-existing instructions and generated blocks in that file are intact; no `CLAUDE.md` or other per-agent copy was created; and every named skill is confirmed installed.
