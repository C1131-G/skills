...
description: Vitest pyramid, DB isolation, AAA. Called by master / backend router.
disable-model-invocation: true
---
# Backend Testing Rules (Vitest)
...
- **Service/business logic** (per `backend-architecture`'s layering): unit test directly, no HTTP involved. Mock the repository layer.
